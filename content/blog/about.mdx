...
[Aurora](https://retailnext.net/product/aurora) camera, an edge based camera used
...
Check out my [linkedin](https://www.linkedin.com/in/andorsk/) for my profile page.

## Technical Experience

Seasoned full-stack engineer, including devops. Since I've had to build most
things from the ground up, I've learned how to use many tools to get the job
done in the most effective way.

### Langaguges ( in order of preference )

1. Golang -- Great langugage with a great design pattern.
2. Python -- Great for data projects.
3. Typescript -- Painful, but I do.
4. Rust -- Some experience, but would love more.
5. lisp -- For my Emacs. Not a fan.
...
3. Budgeting/Projections
4. Helping raise rounds

### Focuses

I am focused on building applications with impact.

1. AI Applications and Development : I have experience 2 startups in Computer Vision and Behavioral Understanding with AI.
2. Decentralized Identity : Tons of open source experience, leader of multiple open source initiatives, and ran a few startups in this space.
